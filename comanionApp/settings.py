"""
Django settings for comanionApp project.
...
SECRET_KEY = 'django-insecure-r*k*&l$(=($8n35=2e$d@x&3rfy(^siqzugn$@b=#_*1c7ns(k'
...
WSGI_APPLICATION = 'comanionApp.wsgi.application'
